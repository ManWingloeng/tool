#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time    : 18-9-10 上午10:59
# @Author  : 胡大为
# @Site    : 
# @File    : tfannotation.py
# @Software: ImageNetBundle

# import the necessary packages
from tensorflow.models.research.object_detection.utils.dataset_util import bytes_list_feature
from tensorflow.models.research.object_detection.utils.dataset_util import float_list_feature
from tensorflow.models.research.object_detection.utils.dataset_util import int64_list_feature
from tensorflow.models.research.object_detection.utils.dataset_util import int64_feature
from tensorflow.models.research.object_detection.utils.dataset_util import bytes_feature
